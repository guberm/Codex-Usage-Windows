...
Validation: 34 automated data/authentication/storage checks; WPF smoke test against the published executable. Authentication fixtures and preview images use synthetic data; live sign-in and spending a real reset credit are not part of automated acceptance.
